        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block">
              ...
              <span className="text-slate-500 text-sm ml-1">Ghana</span>
            </Link>
            <p className="mt-4 text-sm leading-relaxed">
              Premium vehicles and reliable auto services in Accra. Your trusted partner for car sales and repair.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/inventory" className="hover:text-amber-400 transition-colors">Inventory</Link></li>
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm">
              ...
              <p>
                <a href="tel:+233244000000" className="hover:text-amber-400 transition-colors">+233 24 400 0000</a>
              </p>
              <p>
                <a href="mailto:info@benzgategh.com" className="hover:text-amber-400 transition-colors">info@benzgategh.com</a>
              </p>
              <p>
                <a href="https://wa.me/233244000000" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 transition-colors inline-flex items-center gap-2">
