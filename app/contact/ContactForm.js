        ...
        <div>
          <div className="space-y-8">
            ...
            <div>
              ...
              <a href="tel:+233244000000" className="text-amber-500 hover:text-amber-400">
                +233 24 400 0000
              </a>
            </div>
            <div>
              <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Email</h3>
              <a href="mailto:info@benzgategh.com" className="text-amber-500 hover:text-amber-400">
                info@benzgategh.com
              </a>
            </div>
            <div>
          ...
          {/* Map */}
          <div className="mt-8 rounded-xl overflow-hidden h-64 bg-slate-200 dark:bg-slate-700">
            <iframe
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-8">
            ...
            {submitted ? (
              <div className="py-12 text-center">
                <p className="text-green-500 font-semibold mb-2">Thank you for your message!</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-white"
                  />
                </div>
                <div>
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-500 hover:bg-amber-400 text-slate-900 font-semibold py-4 rounded-lg transition-colors"
                >
                  Send Message
                </button>
              </form>
